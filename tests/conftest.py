...
# this gives a way to test routes without doing 'flask run'
@pytest.fixture 
def app():
    ...
    with app.app_context():
        db.create_all()  # sets up the data base, builds tables
        yield app   # wait for the tests to run (?)

    with app.app_context():
        db.drop_all()  # cleans up the db; empties it out

# this takes the above fixture 'app' and passes it into this function        
@pytest.fixture 
def client(app):
